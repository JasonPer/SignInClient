<template>
	<view style="height: 100px;">
		<view style="margin-top: 30%;">
			...
			<view style="display: flex;justify-content: center;"><input type="text" placeholder="请输入您的手机号" class="search"
				 v-model="uMobile" /></view>
			<button class="btn" @click="handInput" type="primary">签到</button>
		</view>
		<view class="location">
			<text>当前位置：</text>
			<text>{{uLocation}}</text>
